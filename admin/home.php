...
<div class="content">
    ...
    <!-- Sidebar ends -->
  	  	...
  	  	<!-- Main bar -->
       <?php
	/*switch(isset($_REQUEST['pages']))
	{
		case 'Companies' : include "Companies.php";
		break;
		case 'art' : include "add_art.php";
		break;
		case 'ved' : include "add_vedio.php";
		break;
		case 'view_art' : include "view_art.php";
		break;
		default : include "dashboard1.php";
	}*/
