...
<div class="content">
    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
	    ...
	    <!-- Page heading -->
	    <div class="page-head">
	      <h2 class="pull-left"><i class="fa fa-shopping-cart"></i> Products</h2>
              ...
              <div class="col-md-12">
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <br />
                    <!-- Form starts.  -->
                     <form class="form-horizontal" method="post" action="setting.php?admin=add_product" enctype="multipart/form-data" role="form">
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-5">
                                    <textarea name="product_description" placeholder="Textarea" rows="5" class="form-control"></textarea>
                                  </div>
                                </div>
                             
                                <div class="form-group">
                                  <label class="col-lg-2 control-label">Product Images</label>
                                  <div class="col-lg-5">
                                ...
                                <div class="form-group">
                                  <div class="col-lg-offset-2 col-lg-6">
                                    <input type="submit" value="Add Product" name="add_product" class="btn btn-sm btn-danger" />
                                  </div>
                                </div>
                              </form>
                      <!-- form -->
               ...
               <!-- update form -->   <?php 
					if(isset($_REQUEST['update']))
					{
						if($_REQUEST['update']=="update_companydata")
						{
							...
							$qr=mysql_query("select * from companies where 	company_id='$company_id'");
                ...
                <div class="widget-head">
                  <div class="pull-left">Update Product data</div>
                  <div class="widget-icons pull-right">
                    <a href="#" class="wminimize"><i class="fa fa-chevron-up"></i></a> 
                    <a href="#" class="wclose"><i class="fa fa-times"></i></a>
                  </div>
...
document.getElementById('abc').style.display = "block";
              ...
              <div class="widget">
                <div class="widget-head">
                  <div class="pull-left"><i class="fa fa-shopping-cart"></i>&nbsp;&nbsp;&nbsp;Products
</div>
                  <div class="widget-icons pull-right">
                    <a href="#" class="wminimize"><i class="fa fa-chevron-up"></i></a> 
                    <a href="#" class="wclose"><i class="fa fa-times"></i></a>
...
$("#divdeps").dialog('open');
								 ...
								 <a href="Companies.php?company_id=<?php echo $arr['company_id']; ?>&update=update_companydata"><button class="btn btn-xs btn-warning"><i class="fa fa-pencil"></i> </button></a>
								  ...
								  <a href="setting.php?company_id=<?php echo $arr['company_id']; ?>&admin=delete_companydata"><button class="btn btn-xs btn-danger"><i class="fa fa-trash-o"></i> </button></td></a>
